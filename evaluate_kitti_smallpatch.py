...
def kitti_testset(lstm_label_df_path='weights/lstm_label_df.pkl', lstm_model_path='weights/at_bilstm.pth', lstm_label_path='weights/lstm_label_to_int.pkl', bayesian_dataset_path='weights/bayesian_dataset_kitti.json',
         ...
         crf_model_path='weights/crf_model_best.pth', capatch_attacked_instances_car_path='./data/kitti/capatch_attacked_instances_car_small.pkl', phys_attacked_instances_car_path='./data/kitti/phys_attacked_instances_car_small.pkl',slap_attacked_instances_car_path='./data/kitti/slap_attacked_instances_car_kitti_small.pkl', 
         capatch_attacked_instances_ped_path='./data/kitti/capatch_attacked_instances_ped_small.pkl', phys_attacked_instances_ped_path='./data/kitti/phys_attacked_instances_ped_small.pkl' ,slap_attacked_instances_ped_path='./data/kitti/slap_attacked_instances_ped_kitti_small.pkl',
         ...
         phys_car_attacked_path='./data/kitti/attacked_selected/attacked_selected_phys_car_small/', phys_ped_attacked_path='./data/kitti/attacked_selected/attacked_selected_phys_ped_small/',
         capatch_car_attacked_path='./data/kitti/attacked_selected/attacked_selected_capatch_car_small/', capatch_ped_attacked_path='./data/kitti/attacked_selected/attacked_selected_capatch_ped_small/',
         slap_car_attacked_path='./data/kitti/sticked_image/car_applied_kitti_small/', slap_ped_attacked_path='./data/kitti/sticked_image/ped_applied_kitti_small/',):
...
def kitti_subvalset(lstm_label_df_path='weights/lstm_label_df.pkl', lstm_model_path='weights/at_bilstm.pth', lstm_label_path='weights/lstm_label_to_int.pkl', bayesian_dataset_path='weights/bayesian_dataset_kitti.json',
         bayesian_model_path='weights/xgb_lpb_model.json', num_size_x_bin=20, num_size_y_bin=20, num_size_z_bin=20, label_encoder_path='weights/label_encoder_classes.npy', edge_buffer_ratio=(0.2, 0.2), region_size_ratio=(0.3, 0.3),
         behavior_mask_path='weights/tensor_behavior_mask.pt', num_regions=8, num_states=5, num_actions=15, num_inter_actions=1, beam_size=5, small_labelspace=True, use_precompute=False, trust_frame_num=3,
         crf_model_path='weights/crf_model_best.pth', capatch_attacked_instances_car_path='./data/kitti/attacked_addsubtrain/capatch_car_small.pkl', phys_attacked_instances_car_path='./data/kitti/attacked_addsubtrain/phys_car_small.pkl',slap_attacked_instances_car_path='./data/kitti/attacked_addsubtrain/slap_car_small.pkl', 
         capatch_attacked_instances_ped_path='./data/kitti/attacked_addsubtrain/capatch_ped_small.pkl', phys_attacked_instances_ped_path='./data/kitti/attacked_addsubtrain/phys_ped_small.pkl' ,slap_attacked_instances_ped_path='./data/kitti/attacked_addsubtrain/slap_ped_small.pkl',
         ...
         phys_car_attacked_path='./data/kitti/sticked_image/car_phys_small_subtrain/', phys_ped_attacked_path='./data/kitti/sticked_image/ped_phys_small_subtrain/',
         capatch_car_attacked_path='./data/kitti/sticked_image/car_capatch_small_subtrain/', capatch_ped_attacked_path='./data/kitti/sticked_image/ped_capatch_small_subtrain/',
         slap_car_attacked_path='./data/kitti/sticked_image/car_applied_kitti_subtrain_small/', slap_ped_attacked_path='./data/kitti/sticked_image/ped_applied_kitti_subtrain_small/',):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    ...
    phys_car_small_attacked = set()
    for key, value in phys_attacked_instances_car.items():
        if value[0] >= 0.7:
            phys_car_small_attacked.add(key)
            
    phys_ped_small_attacked = set()
    for key, value in phys_attacked_instances_ped.items():
        if value[0] >= 0.7:
            phys_ped_small_attacked.add(key)

    phys_car_small_benign = car_dataset_instance_paths - phys_car_small_attacked
    phys_ped_small_benign = ped_dataset_instance_paths - phys_ped_small_attacked

    capatch_car_small_attacked = set()
    for key, value in capatch_attacked_instances_car_3.items():
        if value[0] >= 0.7:
            capatch_car_small_attacked.add(key)
            
    capatch_ped_small_attacked = set()
    for key, value in capatch_attacked_instances_ped_3.items():
        if value[0] >= 0.7:
            capatch_ped_small_attacked.add(key)

    capatch_car_small_benign = car_dataset_instance_paths - capatch_car_small_attacked
    capatch_ped_small_benign = ped_dataset_instance_paths - capatch_ped_small_attacked

    slap_car_small_attacked = set()
    for key, value in slap_attacked_instances_car.items():
        if value[0] >= 0.7:
            slap_car_small_attacked.add(key)
                
    slap_ped_small_attacked = set()
    for key, value in slap_attacked_instances_ped.items():
        if value[0] >= 0.7:
            slap_ped_small_attacked.add(key)

    slap_car_small_benign = car_dataset_instance_paths - slap_car_small_attacked
    slap_ped_small_benign = ped_dataset_instance_paths - slap_ped_small_attacked

    print("# Obj")
    print(f"Total:  {len(phys_car_small_attacked)+len(capatch_car_small_attacked)+len(slap_car_small_attacked)+len(phys_ped_small_attacked)+len(capatch_ped_small_attacked)+len(slap_ped_small_attacked)+len(phys_car_small_benign|capatch_car_small_benign|slap_car_small_benign|phys_ped_small_benign|capatch_ped_small_benign|slap_ped_small_benign)}")
    print(f"Attacked: {len(phys_car_small_attacked)+len(phys_ped_small_attacked)+len(capatch_car_small_attacked)+len(capatch_ped_small_attacked)+len(slap_car_small_attacked)+len(slap_ped_small_attacked)}")
    print()
