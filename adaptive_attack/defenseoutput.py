...
from phySense_initial import phySense_initial as phySense
...
class yolo_with_guard_car_detection():
    def __init__(self, device, lstm_label_df, trust_frame_num):
        ...
        self.phySense = phySense.phySense(lstm_model_path='weights/at_bilstm.pth',
                                                ...
                                                small_labelspace=True, use_precompute=False)
    ...
    def inference(self, indices, filenames, size_xs, size_ys, size_zs, padded_beh_seqs, lengths, batch_masks,
        ...
        with torch.no_grad():
            ...
            outputGuard = self.phySense.decode(filenames, size_xs, size_ys, size_zs, padded_beh_seqs, lengths, batch_masks,
...
def on_gen(ga_instance):
    ...
    showtensor(solution_tensor, save_dir=f'./adaptive_attack/pygad_sol_defenseoutput/{ga_instance.generations_completed}.png')

os.makedirs('./adaptive_attack/gad_pert/', exist_ok=True)
os.makedirs('./adaptive_attack/pygad_sol_defenseoutput/', exist_ok=True)

ga_instance = pygad.GA(num_generations=50,# 100,
...
np.save('./adaptive_attack/fitness_values_defenseoutput.npy', ga_instance.best_solutions_fitness)

ga_instance.plot_fitness(save_dir='./adaptive_attack/pygad_fitness_defenseoutput.png')

solution, solution_fitness, solution_idx = ga_instance.best_solution()
np.save('./adaptive_attack/best_solution_defenseoutput.npy', solution)
print(f"Parameters of the best solution : {solution}")
print(f"Fitness value of the best solution = {solution_fitness}")
print(f"Index of the best solution : {solution_idx}")

solution_tensor = torch.tensor(solution.reshape((3, 600, 600)), dtype=torch.float32)
showtensor(solution_tensor, save_dir='./adaptive_attack/pygad_sol_defenseoutput.png')
ga_instance.save(filename='./adaptive_attack/pygad_instance_defenseoutput')
