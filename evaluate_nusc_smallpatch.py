...
if __name__ == '__main__':
    ...
    with open('./data/nusc/attacked_selected/advpath_capatch_attacked_instances_car_small_3_cornershash.pkl', 'rb') as f:
    ...
    with open('./data/nusc/attacked_selected/advpath_phys_attacked_instances_car_small_cornershash.pkl', 'rb') as f:
        phys_attacked_instances_car = pickle.load(f)
        phys_attacked_instances_car = dict(sorted(phys_attacked_instances_car.items()))
    with open('./data/nusc/attacked_selected/advpath_slap_attacked_instances_car_cornershash_small.pkl', 'rb') as f:
        slap_attacked_instances_car = pickle.load(f)
        slap_attacked_instances_car = dict(sorted(slap_attacked_instances_car.items()))
    with open('./data/nusc/attacked_selected/advpath_capatch_attacked_instances_ped_small_3_cornershash.pkl', 'rb') as f:
    ...
    with open('./data/nusc/attacked_selected/advpath_phys_attacked_instances_ped_small_cornershash.pkl', 'rb') as f:
        phys_attacked_instances_ped = pickle.load(f)
        phys_attacked_instances_ped = dict(sorted(phys_attacked_instances_ped.items()))
    with open('./data/nusc/attacked_selected/advpath_slap_attacked_instances_ped_cornershash_small.pkl', 'rb') as f:
